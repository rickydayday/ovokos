...
<h3 class="font-weight-bolder text-info text-gradient">Register Page</h3>
<p class="mb-0">Welcomed To Join Us</p>
</div>
<div class="card-body">
...
<div class="mb-3">
<input id="password" type="password" class="form-control" name="password" placeholder="Password" aria-label="Password" aria-describedby="password-addon">
</div>
...
<div class="mb-3">
<input id="c-password" type="password" class="form-control" name="password2" placeholder="Password" aria-label="Password" aria-describedby="password-addon">
</div>
...
<div class="text-center">
<a href="./index.php"><p>Have An Account Already ? Sign In Here</p></a>
</div>
</form>
</div>

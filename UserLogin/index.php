...
<h3 class="font-weight-bolder text-info text-gradient">Login First</h3>
<p class="mb-0">Login Page</p>
</div>
<div class="card-body">
...
<button id="login" type="submit" name="login_btn" class="btn bg-gradient-info w-100 mt-4 mb-0">Login</button>
</div>


<div class="text-center">
<a href="./registerPage.php"><p>Dont Have An Account ? Register Here</p></a>
</div>
</form>
</div>

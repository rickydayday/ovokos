...
<img src="../assets/Untitled-removebg-preview (1).png" class="navbar-brand-img" alt="main_logo">
<!-- <span class="ms-1 font-weight-bold">Γίνε Vοσκός oriuepa</span> -->
</a>
</div>
...
<li class="nav-item">
<a href="./Urls" class="nav-link " role="button" aria-expanded="false">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
...
<span class="nav-link-text ms-1">URLS</span>
</a>

</li>
<li class="nav-item">
<a href="./AddUser" class="nav-link " role="button" aria-expanded="false">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
...
<li class="nav-item">
<a href="./ListUser" class="nav-link "  role="button" aria-expanded="false">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
...
<span class="nav-link-text ms-1">User Lists</span>
</a>

</li>
<li class="nav-item">
<a data-bs-toggle="collapse" href="./ListUser" class="nav-link " aria-controls="componentsExamples" role="button" aria-expanded="false">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
...
<div class="full-background" style="background-image: url('https://raw.githubusercontent.com/creativetimofficial/soft-ui-dashboard/main/assets/img/curved-images/white-curved.jpg')"></div>
...
<div class="d-lg-flex">
<div>
<h5 class="mb-0">Paid Pixels</h5>
<p class="text-sm mb-0">
Overview Of Paid Lambs
</p>
</div>
...
<h5 class="modal-title" id="ModalLabel">Register Client</h5>
...
<img class="img-fluid" width="30" height="30" src="../requests/uploads/<?php echo $row['file']; ?>" alt="logo">

</div>
</td>
<td class="text-sm"><?php echo $row['name'];?></td>
<td class="text-sm"><?php echo $row['email'];?></td>

<td class="text-sm"><?php echo $row['dob']; ?></td>
<td class="text-sm"><?php echo $row['url']; ?></td>
...
<a href="https://ovokos.com" class="font-weight-bold" target="_blank">OVOSKOS</a>
...
<script src="./assets/js/plugins/three.js"></script>
...
<!-- <script type="module" src="server/requests.js"></script> -->

<script src="./assets/js/soft-ui-dashboard.min.js"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"7721d15fec329cca","version":"2022.11.3","r":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
</body>
</html>
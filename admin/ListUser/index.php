...
<li class="nav-item">
<a href="./ListUser" class="nav-link active" role="button" aria-expanded="false">
<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
...
<span id="logout" class="d-sm-inline d-none">Logout</span>
</a>
</li>
...
<a href="../AddUser" class="btn bg-gradient-primary btn-sm mb-0" target="_blank">+&nbsp; Add User</a>
...
<td class="text-sm"><?php echo $row['username'];?></td>
<td class="text-sm"><?php echo $row['phone']; ?></td>
<td class="text-sm"><?php echo $row['location']; ?></td>
<td>
<span class="badge badge-success badge-sm">Active</span>
</td>
<td class="text-sm">
<a href="delete.php?id='.$row['id'].'" data-bs-toggle="tooltip" data-bs-original-title="Delete product">
